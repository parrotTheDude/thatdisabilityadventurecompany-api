...
import { getEmailTemplates, editEmailTemplate, sendBulkEmail, getSentEmails } from "../controllers/emailController";
...
router.post("/send", protect, sendBulkEmail); // ✅ Send bulk email
